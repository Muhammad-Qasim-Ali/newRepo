  ...
  return (
    <>
      <div className='container mx-auto' style={{ color: props.mode === 'dark' ? 'white' : 'black' }}>
        ...
        <button disabled={text.length === 0} className="btn btn-primary mx-1 my-1 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handleExtraSpaces}>Remove Extra Spaces</button>
      </div>
